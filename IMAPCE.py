...
from funcs import mahalanobis_distances_between_clusters, SelectFromCollection, plot_clustering_results
...
class IMAPCE():
    ...
    def Explore(self):
        ...
        root = os.getcwd() + '\\Results\\' + self.dataset_name + '\\' + folder_to_write + '\\'  #replace with the folder you want to save the results
        ...
        for i in range(self.max_exploration_iterations):
            ...
            if self.selection == "automatic": # automatic selection of the most distinct cluster
                ...
                for count,selected_cluster in enumerate(selected_cluster_val):
                    ...
                    plot_clustering_results(root = path, most_informative_cluster = selected_cluster, iteration = i,
